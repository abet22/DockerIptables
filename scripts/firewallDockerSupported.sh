...
###################      VARIABLES    ##############################
# ADD VARIABLES HERE SUCH AS MACHINES IPS, NETWORKS... 
####################################################################
...
$IPTABLES -A DOCKER-USER -i ens32 -j FILTERS
...
###################################   SPECIFIC RULES    #######################################
# HERE GOES ALL SPECIFIC RULES YOU WANT. YOU CAN DIVIDE THEM VIA SERVICES, MACHINES, NETWORKS...
# THERE IS A SIMPLE EXAMPLE ONN THIS REPOSITORY.
###################################################################################################
